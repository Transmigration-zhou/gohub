...
func UserProfileUpdate(data interface{}, c *gin.Context) map[string][]string {
...
func UserEmailUpdate(data interface{}, c *gin.Context) map[string][]string {
...
func UserPhoneUpdate(data interface{}, c *gin.Context) map[string][]string {
	currentUser := auth.CurrentUser(c)
	rules := govalidator.MapData{
		"phone": []string{
			"required",
...
func UserAvatarUpdate(data interface{}, c *gin.Context) map[string][]string {
	rules := govalidator.MapData{
